...
function SketchCard() {
  return (
    <div className="rounded-2xl border-2 p-5" style={{
      ...
      <div className="mb-4 rounded-xl border-2 border-dashed border-gray-400/50 bg-gray-200/30 dark:bg-gray-700/20 p-4 text-center">
...
function WireframeCard() {
  return (
    <div className="rounded-2xl border border-gray-400/40 bg-gray-50/50 dark:bg-gray-900/50 p-5">
      {/* Wireframe nav */}
      ...
      {/* Wireframe image */}
      <div className="mb-4 h-28 rounded-lg border border-gray-300/40 bg-gray-200/40 dark:bg-gray-700/30 flex items-center justify-center">
        <div className="text-xs text-gray-400 font-mono">300 × 180</div>
      </div>
      {/* Text blocks */}
  ...
  return (
    <div className={cn(
      ...
      <div className="p-5">
        ...
        <h3 className="text-lg font-extrabold leading-tight">A product built to convert.</h3>
...
export function LayoutSkeletonTransitions() {
  ...
  return (
    ...
    >
      {/* Tabs */}
      <div className="mb-6 flex gap-1 rounded-xl border border-border bg-card/60 p-1 w-fit">
        {STAGES.map((s, i) => (
          <button
            key={s}
            onClick={() => setStage(i)}
