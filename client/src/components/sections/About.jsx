          ...
          >
            <Reveal>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                ...
                <span className={cn("inline-flex items-center gap-1 font-medium", isDark ? "text-foreground" : "text-foreground")}>
                  <MapPin className="h-3.5 w-3.5 text-primary" /> Ohio · EST
                </span>.
            ...
            <Reveal>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                ...
                The constraint was deliberate: if I can&apos;t explain every component under pressure, I don&apos;t
                understand it well enough. Nexus has 18 MITRE ATT&CK techniques mapped, a full FastAPI operator server,
            ...
            <Reveal>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                I&apos;m also pre-enlistment, ASVAB-qualified, and targeting the USAF{" "}
                <strong className={isDark ? "text-foreground" : "text-foreground"}>1B4X1 Cyber Warfare Operations</strong>{" "}
                career field. Security+ is done; EDPT is pending. That track is context for why I build what I build —
                not the front-page narrative.
              </p>
            </Reveal>
          </motion.div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    regression. I apply it constantly — it&apos;s the reason I write post-mortems after every
                    project phase.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-center lg:justify-start">
              <div className={cn(
                ...
                <img
                  ...
                  alt="Brant Simpson — placeholder avatar, replace with headshot"
                  width="220"
                  height="220"
