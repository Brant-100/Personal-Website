...
export const CONTACT_LINKS = [
  {
    id: "email",
    label: "Email",
    handle: "brantsimpson100@gmail.com",
    ...
    <Section id="contact" className="container">
      ...
      <Reveal className="mb-12 max-w-3xl">
        ...
        <p className="mt-4 text-muted-foreground text-lg">
          Email me directly, or find me on the usual suspects.
        </p>
      </Reveal>
...
function ContactCard({ link, index, isDark }) {
  ...
  return (
    <motion.a
      ...
      className={cn(
        "group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl p-6 transition-all",
        isDark
